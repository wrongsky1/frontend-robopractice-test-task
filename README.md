...
2. Перейти в папку client командой `cd client`
3. Запустить команду `npm run start`

и по адресу http://localhost:3000/ можно проверить тестовое задание

### Результат выглядит так
![result-example](https://github.com/wrongsky1/frontend-robopractice-test-task/blob/master/client/src/utils/IMB_UhdiXi.GIF)
